...
typedef enum { 
  ...
  TLS_AES_128_CCM_SHA256 = 0x1304, /**< see RFC 8446 */
  TLS_AES_128_CCM_8_SHA256 = 0x1305, /**< see RFC 8446 */
  // MF: TODO remove tls 1.2 cipher suites
