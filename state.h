...
// MF: note. unused states:
//  DTLS_STATE_INIT
//  DTLS_STATE_WAIT_CLIENTHELLO
//  DTLS_STATE_FINISHED
typedef enum { 
  DTLS_STATE_INIT = 0, DTLS_STATE_WAIT_CLIENTHELLO, DTLS_STATE_WAIT_CLIENTCERTIFICATE,
  // MF: TODO remove state client key exchange
  DTLS_STATE_WAIT_CLIENTKEYEXCHANGE, DTLS_STATE_WAIT_CERTIFICATEVERIFY,
  // MF: TODO remove state wait change cipher spec
  DTLS_STATE_WAIT_CHANGECIPHERSPEC,
  DTLS_STATE_WAIT_FINISHED, DTLS_STATE_FINISHED, 
  DTLS_STATE_WAIT_FINISHED_ACK,
  /* client states */
  DTLS_STATE_CLIENTHELLO, DTLS_STATE_WAIT_ENCRYPTED_EXTENSIONS, DTLS_STATE_WAIT_SERVERCERTIFICATE,
  // MF: TODO remove state wait key exchange
  DTLS_STATE_WAIT_SERVERKEYEXCHANGE,
  // MF: TODO remove state wait server hello done
